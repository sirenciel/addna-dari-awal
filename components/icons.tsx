...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
      <path d="M10.68 13.31C10.26 12.52 10 11.57 10 10.5c0-2.21 1.79-4 4-4 .19 0 .37.01.55.03" />
      <path d="M13.5 10.5c0-2.21-1.79-4-4-4s-4 1.79-4 4c0 1.25.58 2.34 1.48 3.06" />
      <path d="M14.5 19.5c0 1.66-1.34 3-3 3s-3-1.34-3-3" />
      <path d="M19.43 14.82C20.36 15.19 21 16.03 21 17c0 1.66-1.34 3-3 3-1.04 0-1.93-.53-2.45-1.32" />
      <path d="M14.5 4.5c0-1.66-1.34-3-3-3s-3 1.34-3 3c0 .35.06.68.17.99" />
      <path d="M10.15 11.47C9.53 12.07 9 13.01 9 14c0 1.66 1.34 3 3 3 .75 0 1.41-.27 1.93-.72" />
    </svg>
);
...
export const HeartCrackIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path>
        <path d="m16 13-2-2-2 2-2-2"></path>
    </svg>
);
...
export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
    ...
    <path d="M6 13L8.6 15.6a2 2 0 0 0 2.8 0L14 13" />
    <path d="M6 13H4a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2h-2" />
    <path d="M12 13V4" />
  </svg>
);
...
export const FlaskConicalIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
    <path d="M8.5 2h7" />
    <path d="M12 2v6.3" />
    <path d="m12 8.3 5.5 9.8c.2.3.2.8 0 1.1a1.9 1.9 0 0 1-1.7 1H8.2c-.7 0-1.4-.4-1.7-1a1.9 1.9 0 0 1 0-1.1L12 8.3z" />
  </svg>
);
...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} {...props}>
    ...
    <path d="M21.5 13.5c1.5 1.5 1.5 3 0 4.5" />
    <path d="M16.5 4.5c1.5 1.5 3 1.5 4.5 0" />
    <path d="m2 2 7 7" />
    <path d="m9 2 7 7" />
    <path d="M2 9l7 7" />
    <path d="M9 9l7 7" />
